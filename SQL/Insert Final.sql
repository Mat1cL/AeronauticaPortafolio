...
insert into usuario values('18.769.454-K',lower(DBMS_OBFUSCATION_TOOLKIT.md5(input => UTL_RAW.cast_to_raw('123'))),1);
insert into usuario values('8.545.173-1',lower(DBMS_OBFUSCATION_TOOLKIT.md5(input => UTL_RAW.cast_to_raw('123'))),3);
insert into usuario values('19.115.133-K',lower(DBMS_OBFUSCATION_TOOLKIT.md5(input => UTL_RAW.cast_to_raw('123'))),2);
insert into usuario values('18.534.831-8',lower(DBMS_OBFUSCATION_TOOLKIT.md5(input => UTL_RAW.cast_to_raw('123'))),2);
...
insert into modelo values(1,'Airbus A320 - Avión',2500);
INSERT INTO MODELO VALUES (2,'Bell 47 - Helicóptero',2500);
INSERT INTO MODELO VALUES (3,'Boeing 737 - Avión',2500);
...
insert into mantenimiento values(id_mantenimiento.nextval,'2500 Horas de Vuelo');
insert into mantenimiento values(id_mantenimiento.nextval,'5000 Horas de Vuelo');
insert into mantenimiento values(id_mantenimiento.nextval,'10000 Horas de Vuelo');
insert into mantenimiento values(id_mantenimiento.nextval,'Mantenimiento de Emergencia');
...
INSERT INTO PILOTO VALUES('19.115.133-K','MATIAS','TORRES','VENEGAS','01/01/1995','matitorres28@gmail.com','AV FALSA 2','12345678','12345678',1,1101,1);
insert into ficha_medica values(id_ficha_medica.nextval, '06/12/2017','ASDASD','19.115.133-K');
insert into ficha_medica values(id_ficha_medica.nextval, '06/12/2017','ASDASD','18.534.831-8');
...
INSERT INTO AERONAVE (MATRICULA,FECHA_INSPECCION_ANUAL,ANO_FABRICACION,TIPO_AERONAVE_ID_TIPO_AERONAVE,FABRICANTE_ID_FABRICANTE,MODELO_ID_MODELO,ESTADO_ID_ESTADO) VALUES ('AB-123','24/10/2017',2016,'1','1','1','1');

INSERT INTO COMPONENTE (ID_COMPONENTE, NOMBRE_COMPONENTE, DESCRIPCION, PROVEEDOR_ID_PROVEEDOR, AERONAVE_MATRICULA, FECHA_INGRESO) VALUES (id_componente.nextval,'ALA','ALA QUE CONFORMA LA AERONAVE',2,'AB-123','24/10/2016');
INSERT INTO COMPONENTE (ID_COMPONENTE, NOMBRE_COMPONENTE, DESCRIPCION, PROVEEDOR_ID_PROVEEDOR, AERONAVE_MATRICULA, FECHA_INGRESO) VALUES (id_componente.nextval,'CABINA DE AVIÓN','CABINA DE AVIÓN QUE CONFORMA LA AERONAVE',2,'AB-123','24/10/2016');
INSERT INTO COMPONENTE (ID_COMPONENTE, NOMBRE_COMPONENTE, DESCRIPCION, PROVEEDOR_ID_PROVEEDOR, AERONAVE_MATRICULA, FECHA_INGRESO) VALUES (id_componente.nextval,'FUSELAJE','FUSELAJE QUE CONFORMA LA AERONAVE',2,'AB-123','24/10/2016');
INSERT INTO COMPONENTE (ID_COMPONENTE, NOMBRE_COMPONENTE, DESCRIPCION, PROVEEDOR_ID_PROVEEDOR, AERONAVE_MATRICULA, FECHA_INGRESO) VALUES (id_componente.nextval,'MOTOR DE REACCIÓN','MOTOR DE REACCIÓN QUE CONFORMA LA AERONAVE',2,'AB-123','24/10/2016');
