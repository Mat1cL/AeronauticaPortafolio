...
ALTER TABLE cond_tipo_cond ADD CONSTRAINT cond_tipo_cond__IDX PRIMARY KEY ( condicion_id_condicion, tipo_cond_id_tipo ) ;
...
ALTER TABLE usuario_mision ADD CONSTRAINT usuario_mision__IDX PRIMARY KEY ( usuario_rut, mision_id_mision ) ;
...
ALTER TABLE usuario_plan_vuelo ADD CONSTRAINT usuario_plan_vuelo__IDX PRIMARY KEY ( usuario_rut, plan_vuelo_id_vuelo ) ;
