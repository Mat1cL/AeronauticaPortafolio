    ...
    public partial class ConsultarMantenimientos : Form
    {
        ...
        private void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                conn.Open();
                OracleCommand cmd = new OracleCommand(""+(consultas.Variables.ConsultarMantenimientos)+"", conn);
        ...
        private void btnFiltrar_Click(object sender, EventArgs e)
        {
                    ...
                    cnn.Open();
                    string sqlString2 = ""+(consultas.Variables.FiltrarMatriculaMantenimientoValidarSiExiste)+" '"+txtMatricula.Text+"'";
                    ...
                    if (reader.Read())
                    {
                        try
                        {
                            OracleConnection conn = new OracleConnection((consultas.Variables.ConString));
                            conn.Open();
                            OracleCommand cmd = new OracleCommand(""+(consultas.Variables.FiltrarMatriculaMantenimiento)+" '" + txtMatricula.Text + "'", conn);
                            cmd.CommandType = CommandType.Text;
                            DataSet ds = new DataSet();
                            OracleDataAdapter da = new OracleDataAdapter();
                            da.SelectCommand = cmd;
                    ...
                    {
                        MessageBox.Show("La Aeronave filtrada no se encuentra en Mantenimiento", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
        ...
        private void btnReporte_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sfd.FileName = "Reporte Mantenimientos";
